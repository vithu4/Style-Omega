...
public class shirtsDisplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shirts_display);
        ...
        LinearLayout linearLayout=(LinearLayout)findViewById(R.id.lLShirtDis);
            ...
            if(ClothType.equals("shirts")) {
                ...
                viewmore.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(shirtsDisplay.this, viewOneProduct.class);
                ...
                wishList.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(shirtsDisplay.this, "Product has been added to the WishList ", Toast.LENGTH_SHORT).show();
                ...
                shopCard.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        String dd=v.getTag().toString();
                        Toast.makeText(shirtsDisplay.this, "Product has been added to the Shopping Cart ", Toast.LENGTH_SHORT).show();
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(shirtsDisplay.this, Navigation.class));
        finish();
