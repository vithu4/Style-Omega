...
public class jeansDisplay extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jeans_display);
  ...
  LinearLayout linearLayout=(LinearLayout)findViewById(R.id.lL1);
            ...
            if(ClothType.equals("jeans")) {
                ...
                viewmore.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(jeansDisplay.this, viewOneProduct.class);
                ...
                wishList.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(jeansDisplay.this, "Product has been added to the WishList ", Toast.LENGTH_SHORT).show();
                ...
                shopCard.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        String dd=v.getTag().toString();
                        Toast.makeText(jeansDisplay.this, "Product has been added to the Shopping Cart ", Toast.LENGTH_SHORT).show();
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(jeansDisplay.this, Navigation.class));
        finish();
